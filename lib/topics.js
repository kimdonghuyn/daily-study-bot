...
export const CYCLE_LENGTH = TOPIC_POOL.length * TYPE_SEQUENCE.length; // 108

export const CURRICULUM = [
  { category: '☕ Java / OOP',         topics: TOPIC_POOL.slice(0, 5)  },
  { category: '🍃 Spring',             topics: TOPIC_POOL.slice(5, 13) },
  { category: '🗄️ DB',                topics: TOPIC_POOL.slice(13, 19) },
  { category: '📦 Redis / 캐싱',       topics: TOPIC_POOL.slice(19, 23) },
  { category: '🌐 API / 인증',         topics: TOPIC_POOL.slice(23, 27) },
  { category: '☁️ 인프라',             topics: TOPIC_POOL.slice(27, 31) },
  { category: '🏗️ 메시징 / 아키텍처', topics: TOPIC_POOL.slice(31, 36) },
];
